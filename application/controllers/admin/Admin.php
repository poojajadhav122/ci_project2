...
// exit;
	...
	function forgot3_action(){
		...
		$this->form_validation->set_rules('ucpass','comfrim password:','trim|required|alpha_dash|min_length[4]|max_length[12]|matches[upass]');
